...
func CreateAppInfoFunc(modInfo []byte, releaseID, protoPackage string) func() (*AppInfo, error) {
	return func() (*AppInfo, error) {
		return GetAppInfo(modInfo, releaseID, protoPackage)
	}
}
